...
class SonicStick():
    ...
    def home(self):
        ...
        while True:
            ...
            if alarm==0x285 or alarm==0x283:
                ...
                time.sleep(0.95)
                self.modbusClient.WriteSingleRegister(0x040E, 0x00, 1) # Manual touch endstop
                time.sleep(0.25)
    ...
    def moveMotor(self, howmany, speed, acc,Praddr):
        ...
        self.modbusClient.WriteMultipleRegisters(0x0606, [motordistance & 0xFFFF, motordistance >> 16],1)
        self.run_Pr1()
        time.sleep(0.025)
    ...
    def test(self):
        ...
        # time.sleep(0.25)
        #val=0x00000022
        #self.modbusClient.WriteMultipleRegisters(0x0604, [val & 0xFFFF, val >> 16],1) # Define Pr1~Pr49
        #original acc 21000
        # motordistance=2218750
        # self.modbusClient.WriteSingleRegister(0x0578, 2005, 1)
        # self.modbusClient.WriteMultipleRegisters(0x0606, [motordistance & 0xFFFF, motordistance >> 16],1) #
        # self.run_Pr1()
        # motordistance=2218750*2
        # time.sleep(1)
        # self.modbusClient.WriteSingleRegister(0x0578, 6005, 1)
        # self.modbusClient.WriteMultipleRegisters(0x060A, [motordistance & 0xFFFF, motordistance >> 16],1) #
        # self.modbusClient.WriteSingleRegister(0x050E, 1, 1)
        # self.modbusClient.WriteSingleRegister(0x050E, 1, 1)
        # motordistance=2218750*3
        # time.sleep(1)
        # self.modbusClient.WriteSingleRegister(0x0578, 2005, 1)
        # self.modbusClient.WriteMultipleRegisters(0x0606, [motordistance & 0xFFFF, motordistance >> 16],1) #
        # self.run_Pr1()
        ...
        # Joggggggg
        self.modbusClient.WriteSingleRegister(0x040A, 200, 1)
        self.modbusClient.WriteSingleRegister(0x040A, 4999, 1)
        time.sleep(2)
        self.modbusClient.WriteSingleRegister(0x040A, 400, 1)
        self.modbusClient.WriteSingleRegister(0x040A, 4999, 1)
        time.sleep(2)
        self.modbusClient.WriteSingleRegister(0x040A, 600, 1)
        self.modbusClient.WriteSingleRegister(0x040A, 4999, 1)
        time.sleep(2)
        self.modbusClient.WriteSingleRegister(0x040A, 200, 1)
        self.modbusClient.WriteSingleRegister(0x040A, 4999, 1)
        ...
        #self.modbusClient.WriteSingleRegister(0x040A, 300, 1)
...
class PrQueue():
    ...
    def append(self,PrPos, PrSpeed, PrAcc):
        #self.queueLock=True
        self.queue_mutex.acquire()
        self.move_list.append( [PrPos, PrSpeed, PrAcc,self.nextPrPathAddr] )
        self.queue_mutex.release()
